...
<template>
    <section class="relative flex items-center justify-center min-h-screen overflow-hidden bg-gradient-to-b from-[#a4bbcf] to-[#F5F0E8]">
        ...
        <h1
            class="absolute inset-0 flex items-start mt-20 md:mt-0 justify-center text-[12vw] sm:text-[10vw] md:text-[6vw] font-black uppercase leading-none text-[#ffffff] select-none text-center z-0 pointer-events-none"
        ...
        <div
            ...
            :class="imageRevealed ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-12 scale-95'"
        ...
        <div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-deep-onyx/30 z-20">
        ...
        <div
            ...
            :class="subtitleRevealed ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'"
            style="transition: all 0.8s cubic-bezier(0.22, 1, 0.36, 1);"
        >
            <p class="h-32 border-l border-gray-400"></p>
