        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-50">
                    <tr v-for="s in servicios" :key="s.id" class="hover:bg-slate-50/30 transition-colors">
                        <td class="px-6 py-3">
                            <img v-if="s.image_url" :src="s.image_url" class="size-10 rounded-lg object-cover" />
                            <div v-else class="size-10 rounded-lg bg-slate-100 flex items-center justify-center text-slate-300">
                        ...
                        <form @submit.prevent="submitForm" class="space-y-5">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input v-model="form.key" required class="w-full px-3 py-2.5 rounded-xl border border-slate-200 text-sm focus:border-brand-blue focus:ring-2 focus:ring-brand-blue/10 outline-none" />
                                </div>
                                <div>
